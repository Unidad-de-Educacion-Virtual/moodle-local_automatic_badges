...
$string['designbadge'] = 'Design Badge';
...
$string['editrule_issuedwarning'] = '<strong>Warning:</strong> This rule has already awarded the badge to one or more students. Editing its criteria or conditions may create serious inconsistencies between students who already received it under the previous configuration and those evaluated under the new version.<br><br><strong>Recommendation:</strong> Before modifying the rule\'s behaviour or criterion type, go to the native course badge management and delete the badge (or revoke it from the students) to ensure fairness.';
...
$string['tab_diagnostic'] = 'Diagnostics';
...
$string['testlogic_award'] = 'Award';
$string['testlogic_badge_base_deleted'] = 'The base badge was deleted';
$string['testlogic_badge_deleted'] = 'Deleted Badge';
$string['testlogic_badge_disabled'] = 'Disabled';
$string['testlogic_badge_enabled'] = 'Enabled';
$string['testlogic_checked_by_posts'] = 'Checked by posts';
$string['testlogic_col_activity'] = 'Activity';
$string['testlogic_col_current_status'] = 'Current Status';
$string['testlogic_col_issued'] = 'Issued?';
$string['testlogic_col_meets'] = 'Meets?';
$string['testlogic_col_status'] = 'Status';
$string['testlogic_desc'] = 'Evaluate users individually or apply retroactive reviews to course rules.';
$string['testlogic_evaluate'] = 'Evaluate';
$string['testlogic_evaluate_all'] = 'Evaluate All';
$string['testlogic_evaluate_user'] = 'Evaluate User';
$string['testlogic_global_rule'] = 'Global Rule ({$a})';
$string['testlogic_global_rule_short'] = 'Global Rule';
$string['testlogic_grade_min'] = '(Minimum: {$a}%)';
$string['testlogic_grade_range'] = '(Range: {$a->min}% to {$a->max}%)';
$string['testlogic_issued'] = 'Issued';
$string['testlogic_meets_yes'] = 'YES';
$string['testlogic_multiple'] = 'Multiple';
$string['testlogic_no_rules'] = 'No rules configured in this course. Create at least one rule to use the diagnostic tool.';
$string['testlogic_no_submission'] = 'No submission recorded';
$string['testlogic_not_available'] = 'Not available';
$string['testlogic_pending'] = 'Pending';
$string['testlogic_result_for'] = 'Results for:';
$string['testlogic_retroactive_completed'] = 'Retroactive review completed. Badges awarded: {$a}';
$string['testlogic_retroactive_confirm'] = 'Evaluate this rule retroactively for all enrolled students?';
$string['testlogic_retroactive_desc'] = 'Evaluate a rule for <strong>all</strong> enrolled students and award badges to those who meet the criteria.';
$string['testlogic_retroactive_title'] = 'Retroactive Review';
$string['testlogic_select_user'] = 'Select a user...';
$string['testlogic_submission_delivered'] = 'Submitted:';
$string['testlogic_title'] = 'Diagnostic Tool';
$string['testlogic_unknown_activity'] = 'Unknown (ID: {$a})';
$string['testlogic_unknown_activity_short'] = 'Unknown';
$string['testlogic_user_label'] = 'User:';
$string['testlogic_user_not_found'] = 'User not found or not enrolled.';
